...
import { CarouselImg, Countdown } from "../../_external-component";
...
const Section = (props) => {
  const { children, title, components } = props;

  return (
    <ContentStyle sx={{ backgroundColor: "black" }}>
      <Container maxWidth="xlg" sx={{ p: 10 }}>
        <Grid
          container
          ...
          spacing={25}
        >
          <Grid item xs={12} md={7} dir="ltr" sx={{ pb: 15, pr: 20 }}>
  ...
  return (
    <RootStyle>
      <Grid container spacing={5} justifyContent="center">
        ...
        >
          <ContentStyle>
            <Container maxWidth="xlg" sx={{ my: 10 }}>
              <Grid
                container
                spacing={0}
            ...
            <ImageMagnifier
              src="https://drive.google.com/uc?id=1Qc-Au-tuxe3F4qHdRF2g3zQn69gGwAEP"
              underSrc="https://drive.google.com/uc?id=157H-Ma3cNa81z8umN9BWdqWNJtI--xGp"
            />

            <ContentStyle
              id="buttons"
              sx={{ py: 10, backgroundColor: "black" }}
            >
            ...
            <Container maxWidth="xlg" id="virus" sx={{ py: 15 }}>
              <MotionInView variants={varFadeInUp}>
                <Typography
                  variant="h3"
                  sx={{
              ...
              <MotionInView variants={varFadeInUp}>
                ...
                >
                  ...
                  and its lacomponents adition SARS-CoV-2. Made up of genetic
                  material (DNA or RNA) encapsulated in a shell made of protein,
                  they are only able to survive and replicate inside a living
                  host, which could be any organism on earth, even other
                  microbes like bacteria. This means no life form is safe from
                  infection by a virus. The question wether viruses are alive is
                  tricky to answer, as they do not possess the hallmark of
                  living things, they don’t carry out metabolic processes.
                </Typography>
              </MotionInView>
            </Container>
          </ContentStyle>
      ...
      <div id="virus-description">
        ...
        >
          <span>
            ...
            develop symptoms, as the virus hides from the patroling immune
            system in the body of our nerve cells. In certain cases HSV-1
      ...
      <Container maxWidth="xlg" id="fungi" sx={{ py: 15 }}>
        <MotionInView variants={varFadeInUp}>
          <Typography
            variant="h3"
            sx={{
      ...
      <div id="fungi-description">
        ...
        >
          <span>
            ...
            plates serve as the template for .... (Cara)
          </span>
        </Section>
        ...
        >
          <span>
            ...
            baeocystin produced by the mushroom. The psychodelic compounds act
            as agonists for several serotonin receptors and induce euphoria,
            visual and mental hallucinations, changes in perception, a distorted
            sense of time, and perceived spiritual experiences.
            <br />
            <br />
            ...
            Botany. 91(9): 573-591. https://doi.org/10.1139/cjb-2013-0070.
          </span>
        </Section>
      </div>

      <Container maxWidth="xlg" id="bacteria" sx={{ py: 15 }}>
        <MotionInView variants={varFadeInUp}>
          <Typography
            variant="h3"
            sx={{
      ...
      <div id="bacteria-description">
        ...
        >
          <span>
            ...
            purposes.
            <br />
            <br /> Based on research by Qiyun Zhong, conducted at Imperial
            College London, published in open access journal Plos Biology:
            <br />
